...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(nonnull NSDictionary<UIImagePickerController *,id> *)info
{
...
//    cropController.cancelButtonTitle = @"Cancel";
    NSLog(@"~~~~~~~~~~~~~ Running the code that ruins a square crop ~~~~~~~~~~~~~");
    self.image = image;
